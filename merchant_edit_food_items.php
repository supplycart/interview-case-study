...
<html>
<title>EDIT LISTING | HomeFood</title>
...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    $images_path = $_GET['dimages_path'];
    $availability = $_GET['availability'];
    $category = $_GET['category'];

    $query = mysqli_query($conn, "UPDATE food set
    name='$name', price='$price', description='$description', images_path='$images_path', category='$category',
    availability='$availability' where F_ID='$F_ID'");
    }
    ...
    while ($row = mysqli_fetch_array($query)) {
      ...
      <div class="list-group" style="text-align: center;">
        <?php
      echo "<b><a href='merchant_edit_food_items.php?update= {$row['F_ID']}'>{$row['name']}</a></b>";  
        ?>
      </div>
...
<div class="container-fluid px-1 py-5 mx-auto">
 ...
 <div class="form-card">
                  <form action="merchant_edit_food_items.php" method="GET">
          ...
          <div class="form-group">
                <label class="form-control-label px-3">Food Name <span class="text-danger"> *</span></label> 
            <input type="text" class="form-control" id="dname" name="dname" value=<?php echo $row1['name'];  ?> placeholder="Your Food name" required="">
</div><br>
 <div class="form-card">
                        <label class="form-control-label px-3">Price of Food (in RM) <span class="text-danger"> 
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Food Price (in RM)" required="">

                    </div>
<br>
 <div class="form-card">
                
                      <label class="form-control-label px-3">Category Of food<span class="text-danger"> *</span></label> 
...
<br>
                    <label class="form-control-label px-3">Insert file path for your food images <span class="text-danger"> *</span></label>
  <input type="text" class="form-control" id="dimages_path" name="dimages_path" value=<?php echo $row1['images_path'];  ?> placeholder="Your image path " required="">
                    </div>
    ...
    <div class="form-card">                 
                    ...
                    <label class="form-control-label px-3">Description Of your food<span class="text-danger">  </span></label>
...
<br> <label class="form-control-label px-3">Availability<span class="text-danger"> *</span></label> 
<br>
