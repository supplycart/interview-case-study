...
$query = "INSERT into customer(username,fullname,email,contact,address,password) VALUES('" . $username . "','" . $name . "','" . $email . "','" . $phone . "','" . $address ."','" . $password ."')";
   ...
   <div class="container-fluid">
      <div class="row  justify-content-center align-items-center d-flex text-center h-100">
        <div class="col-12 col-md-8  h-50 ">
            ...
            <p class="lead  text-light mb-5"> <?php echo "Congrats $name! Your registration form is successful." ?> </p> 
<a href="login.php" class="btn bg-danger shadow-lg btn-round text-light btn-lg btn-rised">Login Here</a>
