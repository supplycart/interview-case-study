    ...
    <div>
        <div class="product-row" v-for="item, idx in items">
            <div class="row">
                ...
                <div class="col-md-1"><p>Price (RM): <span :id="'price'+item.id">{{item.price}}</span></p>
                </div>
                <div class="col-md-1"><p :id="'row-total-'+item.id">Total (RM): {{item.rowTotal}}</p></div>
        ...
        <div class="row">
            <div class="col-md-10">
                <p class="text-right">Subtotal (RM): <span id="subtotal">{{total}}</span></p>
        ...
        <template v-if="Object.keys(relatedProduct).length > 0">
            ...
            <div class="row">
                ...
                <div class="col-md-2"><p>Price (RM): {{ relatedProduct.price }}</p></div>
                <div class="col-md-2">
