    ...
    <div class="min-h-screen flex items-center">
        <div class="bg-white w-full max-w-lg rounded-lg shadow overflow-hidden mx-auto">
            <div class="py-4 px-6">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <a href="/password/reset" class="text-gray-600 text-sm hover:text-gray-500">Forget password?</a>
                        <button type="submit"
            ...
            <div class="flex items-center justify-center py-4 bg-gray-100 text-center">
                ...
                <a href="{{ route('register') }}" class="text-blue-600 font-bold mx-2 text-sm hover:text-blue-500">Register now</a>
            </div>
        </div>
    </div>
@endsection
