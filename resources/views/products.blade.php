...
<div class="flex justify-center h-screen">
    <div class="grid grid-cols-3 gap-4">
        ...
        <div>
        <button type="submit" class="w-full max-w-sm mx-auto rounded-md shadow-lg overflow-hidden text-left add-to-cart " data-name="{{ $product->name }}" data-price="{{ $product->price }}" data-id="{{ $product->id }}">
