                    ...
                    <table class="w-full text-sm lg:text-base" cellspacing="0">
                        ...
                        @foreach($order->items as $item)
                            <tr>
                                ...
                                <td class="text-right">
                                  <span class="text-sm lg:text-base font-medium">
                                    MYR {{ number_format($item->total, 2) }}
                                  </span>
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <div class="my-4 mt-6 -mx-2 lg:flex">
                        <div class="lg:px-2 lg:w-full">
                            <div class="p-4 bg-gray-100 rounded-full">
                                <h1 class="ml-2 font-bold uppercase">Shipping Address</h1>
                            </div>
                            <div class="p-4">
                                <textarea class="w-full h-24 p-2 bg-gray-100 rounded" name="address" placeholder="" readonly>{{ $order->address }}</textarea>
                            </div>
                            <div class="p-4 bg-gray-100 rounded-full">
