            ...
            <div class="w-full bg-white px-10">
                ...
                <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                    ...
                    <div class="flex justify-center w-1/5">
                        ...
                        <input class="mx-2 border text-center w-8" type="text" value="{{$product->qty}}">
                ...
                <a href="#" class="flex font-semibold text-sm text-blue-600 mt-8 mb-8">
                    <- Continue Shopping </a> <div class="border-t mt-8">
                        ...
                        <button class="bg-blue-500 font-semibold hover:bg-blue-600 py-3 text-sm text-white uppercase w-full m-3">Checkout</button>
            </div>
        </div>
    </div>
    </div>
