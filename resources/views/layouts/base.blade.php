...
<body class="home-page home-01 ">
						...
						<div class="topbar-menu right-menu">
							<ul>
								...
								@if(Route::has('login'))
									...
									@else
										<!-- If user is not login then show the login link -->
									...
									<div class="wrap-list-cate">
										...
										<ul class="list-cate">
											...
											@foreach ($categories as $category)
												<li class="level-1 category" data-id="{{$category->id}}">{{$category->name}}</li>
											@endforeach
										</ul>
									</div>
								</form>
 ...
 -->
	...
	<div class="container">
			...
			<div id="product-listing" class="container" style="width: 850px;clear: both;margin: 0px;">
				
				@foreach ($products as $product)
					<div class="product product-style-2 equal-elem" style="float: left;text-align: center">
						<figure>
							<img src='{{ asset("assets/images/shoppingCartProducts/$product->id.jpg") }}' style="width: 240px;height:240px;padding:5px">
						</figure>
						<p style="font-weight: bold;"> {{ $product->brand_name }} {{ $product->product_name }} </p>
						<p>(MYR) {{ $product->unit_price }}</p>
						<!-- <button class="add-to-cart">Add to cart</button> -->
						<a href='{{ url("/cart/add/$product->id") }}' class="add-to-cart">Add to cart</a>
					</div>
				@endforeach
