		...
		<div class="w-full flex items-center justify-between">
			...
			<div class="flex w-1/2 justify-end content-center">
                @if (Route::has('login'))
                    <div>
                        @auth
                            <a href="{{ url('/dashboard') }}" class="inline-block text-blue-500 text-3xl no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-4 md:h-auto md:p-4">Dashboard</a>
                        @else
