                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <jet-nav-link :href="route('cart')">Cart [{{ cart_items_count }}]</jet-nav-link>
                            </div>
...
<!--                                        <div class="border-t border-gray-100"></div>-->
                            ...
                            <div class="hidden sm:flex sm:items-center" v-else>
                                ...
                                <!-- register -->
                                <div class="ml-6 relative">
                                    <jet-nav-link :href="route('register')">Register</jet-nav-link>
                                </div>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200" v-if="canLogin">
