...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div v-if="!$page.props.auth.user.is_admin" class="ml-3 relative">
                                <Link :href="route('orders.index')" :active="route().current('orders.index')" aria-label="view favourites" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                ...
                                <Link :href="route('carts.index')" :active="route().current('carts.index')" aria-label="go to cart" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="ml-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <DropdownLink v-if="$page.props.auth.user.is_admin" :href="route('activity')"> Activity </DropdownLink>
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <ResponsiveNavLink v-if="!$page.props.auth.user.is_admin" :href="route('orders.index')"> Orders </ResponsiveNavLink>
                            <ResponsiveNavLink v-if="!$page.props.auth.user.is_admin" :href="route('carts.index')"> Carts </ResponsiveNavLink>
                            <ResponsiveNavLink v-if="$page.props.auth.user.is_admin" :href="route('activity')"> Activity </ResponsiveNavLink>
            ...
            <div v-if="flash.success && show" class="flex items-center justify-between mb-8 max-w-full bg-green-500 rounded">
                <div class="flex items-center">
                    ...
                    <div class="py-4 text-white text-sm font-medium">{{ flash.success }}</div>
                </div>
            ...
            <div v-if="flash.error && show" class="flex items-center justify-between mb-8 max-w-full bg-red-500 rounded">
                <div class="flex items-center">
                    ...
                    <div v-if="flash.error" class="py-4 text-white text-sm font-medium">{{ flash.error }}</div>
                </div>
                <button type="button" class="group mr-2 p-2" @click="show = false">
