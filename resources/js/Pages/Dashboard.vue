        ...
        <div class="w-full my-2 sm:px-6">
            ...
            >
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody class="w-full">
                        <tr v-for="product in products" tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800 bg-white hover:bg-gray-100 border-b border-t border-gray-100">
                            <td class="pl-4">
                                <p class="text-sm font-medium leading-none text-gray-800">{{ product.name }}</p>
                            </td>
                            <td class="pl-12">
                                <p class="text-sm font-medium leading-none text-gray-800">{{ product.price }}</p>
                            </td>
                            <td class="pl-12">
                                <img :src="url+product.image" width="50" height="50" alt="">
                            </td>
                        </tr>
                    </tbody>
                </table>
