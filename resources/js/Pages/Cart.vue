<template>
    <div>
        <div class="relative mr-1">
            <button id="cart" class="flex flex-row cursor-pointer truncate p-2 px-4 rounded">
                <div></div>
                <div @click="cartOpen = !cartOpen" class="flex flex-row-reverse ml-2 w-full text-gray-400 hover:text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500">
                    <div slot="icon" class="relative">
                        <div class="absolute text-xs rounded-full -mt-1 -mr-2 px-1 font-bold top-0 right-0 bg-red-700 text-white">30</div>
            ...
            <div v-if="cartOpen" class="absolute w-full rounded-b border-t-0 z-10">
                <div class="shadow-xl w-64">
                    ...
                    <div class="p-4 justify-center flex">
                        <button class="text-base undefined hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-teal-700 hover:text-teal-100 bg-teal-100 text-teal-700 border duration-200 ease-in-out
