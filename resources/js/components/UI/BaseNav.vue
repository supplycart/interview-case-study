                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="mx-10 flex items-baseline">
                            ...
                            <a href="/order"
                               class="mx-1 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Orders</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
