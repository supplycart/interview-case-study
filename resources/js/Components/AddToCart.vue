<template>
    <button @click="addToCart(productId, quantity)" :disabled="addToCartButton.value"
            :class="addToCartButton.value ? ['bg-gray-300', 'cursor-not-allowed'] : ['bg-blue-500', 'hover:bg-blue-800']"
            class="flex gap-2 items-center text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center"
    >
