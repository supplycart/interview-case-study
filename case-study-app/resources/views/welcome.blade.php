...
@section('content')
    <form action="{{route("addToCart")}}" method="POST" class="space-y-6" id="itemForm">
        ...
        <div class="w-full h-full flex justify-center">
            <div class="w-full max-w-1/2 content-between">
                <table class="table-auto my-5 border border-purple-500 w-full
                text-md text-left rtl:text-right text-black dark:text-black">
