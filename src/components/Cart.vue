<template>
	<div class="container relative">
		<div class="number cursor-pointer" @click="showCart = !showCart">
			({{ cartNumber }}) Cart
		</div>
		<div class="absolute bg-white p-4 rounded-md shadow-md right-1 top-9 w-max" v-show="showCart">
