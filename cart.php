...
<a href="index.php"><button class="btn btn-warning">Continue Shopping</button></a>&nbsp;

<form action="payment.php" method="POST">

  <p align="right">
  <label for="ordertime">Enter time and date for delivery:</label>
  <input type="datetime-local" id="ordertime" name="ordertime" required="">
</p>

  <button type=submit class="btn btn-success pull-right"><span class="glyphicon glyphicon-share-alt"></span> Check Out</button>
</form>
