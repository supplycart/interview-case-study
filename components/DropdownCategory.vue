<template >
  <div class="relative inline-block text-left w-full md:w-1/2">
    <div>
      <button
        type="button"
    ...
    >
      <div
        v-show="dropdownOpen"
        class="z-10 origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg text-gray-700 bg-white dark:text-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 text-right"
      >
        <div
          class="py-1"
          role="menu"
        ...
        >
          ...
          <span
            class="block px-4 py-2 text-sm hover:bg-gray-100 hover:text-gray-900"
            role="menuitem"
            @click="changeCategory('motherboard')"
          >
            Motherboard
          </span>
        </div>
