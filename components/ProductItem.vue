<template>
  ...
  >
    ...
    >
      <button
        class="transform hover:scale-110 motion-reduce:transform-none p-2 rounded-full bg-indigo-600 dark:bg-indigo-800 text-white mx-5 -mb-4 hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500"
        :class="{ 'animate-bounce': cartClick }"
      >
        <NuxtLink to="/home">
          <!-- Heroicon name: cart -->
          <svg
